...
# Title & Objective
cells.append(
    nbf.v4.new_markdown_cell("""# Climate Change, Economic, and Social Wellbeing Analysis
...
cells.append(
    nbf.v4.new_code_cell("""# Fetching the data using Polars for high performance
...
cells.append(
    nbf.v4.new_code_cell("""# Filter data for the latest available year (e.g., 2019)
...
cells.append(
    nbf.v4.new_code_cell("""fig_scatter = px.scatter(
    df_latest.to_pandas(),
    x="gdp_per_capita",
    y="happiness_score",
    hover_name="country_name",
...
cells.append(
    nbf.v4.new_code_cell("""years = df['year'].unique().to_list()
...
cells.append(
    nbf.v4.new_code_cell("""df_reg = df_latest.drop_nulls(
...
cells.append(
    nbf.v4.new_code_cell("""# Prepare scaled data
...
cells.append(
    nbf.v4.new_code_cell("""X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.25, random_state=42)
...
cells.append(
    nbf.v4.new_code_cell("""print("### Data Loading Table (First 5 Rows)\\n")
...
with open(
    "c:/Users/nonmr/Desktop/Projeler/climate-economic-wellbeing-analysis/analyses/Climate_Economic_Wellbeing_Analysis.ipynb",
    "w",
    encoding="utf-8",
) as f:
    nbf.write(nb, f)
